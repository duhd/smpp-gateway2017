 ...
 * @see SMSCListener
 */
public abstract class PDUProcessor implements Serializable {
    /**
     ...
     * The group is basicaly intended to be PropertiesConfig group of active
     * processors.
     *
     * @param group the group this processor belongs to
     */
    public PDUProcessor(String sessionId, PDUProcessorGroup group) {
     ...
     */
    public void setGroup(String sessionId, PDUProcessorGroup g) {
        if (group != null) {
            group.remove(sessionId);
        }
        group = g;
        if (group != null) {
            group.add(sessionId, this);
        }
    }
     ...
     * @see #setGroup(String, PDUProcessorGroup)
     */
    ...
    protected void exit() {
        if (group != null) {
            group.remove(this.getSessionId());
        }
        active = false;
    }
