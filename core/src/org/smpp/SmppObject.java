...
public class SmppObject {
    ...
    static protected Log logger = LogFactory.getLog(SmppObject.class);
    ...
    protected static final String txt_forwarder = "Forwarder: ";
    protected static final String txt_receiver = "Receiver: ";
