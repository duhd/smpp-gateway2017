...
public abstract class PDU extends ByteData {
	...
	public TLV getExtraOptional(short tag) {
		return findOptional(extraOptionalParameters, tag);
	}
	 ...
	 * @see #createPDU(int)
	 */
	public static PDU createPDU(ByteBuffer buffer)
		throws
		...
		if (pdu != null) {
			...
			} catch (NotEnoughDataInByteBufferException ignored) {} // can't fail
	 ...
	 */
	public static PDU createPDU(int commandId) {
