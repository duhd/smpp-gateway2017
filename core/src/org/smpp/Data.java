...
public class Data {
	...
	public static final long RECEIVE_BLOCKING = 15000;
	...
	static public synchronized void setDefaultTon(byte dfltTon) {
		defaultTon = dfltTon;
	}
	static public synchronized void setDefaultNpi(byte dfltNpi) {
		defaultNpi = dfltNpi;
	}

	static public synchronized byte getDefaultTon() {
		return defaultTon;
	}
	static public synchronized byte getDefaultNpi() {
		return defaultNpi;
	}
