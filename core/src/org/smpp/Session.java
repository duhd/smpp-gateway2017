...
public class Session extends SmppObject {
	 ...
	 * @see Receiver
	 */
	private Response send(Request request, boolean asynchronous)
		...
		if ((!asynchronous) && (request.canResponse())) {
			...
			try {
				...
				try {
					...
					debug.write(DSESS, "Going to receive response. PDU " + pdu.debugString());
